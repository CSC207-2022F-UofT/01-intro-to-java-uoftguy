...
public class Basics {
    ...
    public static void main(final String[] args) {
        ...
        /* TOD (Task 1): Write a line of code below that prints the string
         *                Hello World!
         */
        ...
        /*
         * TOD (Task 2): Create a variable named my_variable and assign it the
         *                value 100.
         */
        int my_variable = 100;
        ...
        /*
         * TOD (Task 3): Create a for-loop that loops from 10 to 0, printing
    ...
    public static int oddSum(int[] arr) {
        ...
        /* TOD (Task 5): Complete this method body using a for-loop.
    ...
    /*
     * TOD (Task 6): Submit the changes you made on GitHub!
